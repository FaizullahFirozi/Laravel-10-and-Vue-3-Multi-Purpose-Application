            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody v-else>
                            <tr>
                                <td colspan="6" align="center">No Categories Found. معلومات پیدا نه شول</td>
                            </tr>
                        </tbody>
                ...
                <Form ref="form" @submit="createUser" :validation-schema="editing ? editUserSchema : createUserSchema"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Name:</label>
                            <Field name="name" id="name" type="name" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <Field name="email" type="email" class="form-control" :class="{ 'is-invalid': errors.email }"
                                placeholder="Enter email" aria-describedby="nameHelp" />
    ...
    <div class="modal fade" id="deleteUserModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button @click.prevent="deleteUser" type="submit" class="btn btn-danger">Yes</button>
