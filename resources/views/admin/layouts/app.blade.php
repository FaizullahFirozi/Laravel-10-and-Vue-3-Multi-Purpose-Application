...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app">
        <nav class="main-header navbar navbar-expand navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- Messages Dropdown Menu Language Localization -->
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        {{-- for showing Language name --}}
                        {{-- {{ app()->getLocale() }} --}}
                        <i class="fa fa-language"></i>
                    </a>
                    <div class=" dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        {{-- <a href="{{ route('lang', 'ps') }}" class="dropdown-item"> --}}
                        <!-- Message Start -->
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    ...
                                    {{-- {{ __('menu_local.ps') }}
                        <span class="float-{{ __('menu_local.left_right_direction')}} text-sm text-success"><i class="fa fa-star"></i></span> --}}
                                </h3>
                            </div>
                        </div>
                        <!-- Message End -->
                        </a>
                        {{-- <a href="{{ route('lang', 'fa') }}" class="dropdown-item"> --}}
                        <!-- Message Start -->
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    دری
                                    {{-- {{ __('menu_local.fa') }} --}}
                                    {{-- <span class="float-{{ __('menu_local.left_right_direction')}} text-sm text-warning"><i class="fa fa-star"></i></span> --}}
                                </h3>
                            </div>
                        </div>
                        <!-- Message End -->
                        ...
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    ...
                                    {{-- <span class="float-{{ __('menu_local.left_right_direction')}} text-sm text-danger"><i class="fa fa-star"></i></span> --}}
                                </h3>
                            </div>
                        </div>
                        <!-- Message End -->
    ...
    <script>
        // Faizullah Firozi. This code is only for collapse the side bar 
    ...
    <script>
        // Faizullah Firozi. This code is only for Dark Mode the theme 
